...
После клонирования репозитория необходимо
	...
	выполнить команду "git update-index --skip-worktree .gitmodules" (в них вы можете добавлять ссылки на репозитории-приложения папки app/)
	выполнить команду "git update-index --skip-worktree composer.json" (у вас в проекте могут быть свои зависимости и билиотеки)
	пареключить рабочую директорию в командной строке на app/<приложение> и выполнить "git update-index --skip-worktree cfg/" (в них хранятся данные БД)	
