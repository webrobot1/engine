...
Общеизвестный прицип:
	...
	L. - да, пример - фаилы выше и проект https://github.com/webrobot1/app-map/tree/master/model/Tiled (сохранение карт Tiled из Xml в объекты PHP , загрузка - сохранения из Mysql, формирование изображения на GD)
