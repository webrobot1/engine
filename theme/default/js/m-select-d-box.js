	(function($) {
		...
		MSelectDBox.prototype = {
			...
			"_globalStyles": (function() {
				var styles = {
					...
					".m-select-d-box__list-container": {
						position: "relative", margin: "0px", padding: "0px", "max-height": "500px", "overflow-x": "hidden"
					},
			...
			"applySelectedToInput": function() {
				...
				dboxInput.value =  listLabel.join(",");
				...
				target.setAttribute("data-msdb-value",  dboxInput.value);
